...
class CheckBoxEditor<Values = {}, Props = {}> extends React.Component<
  any & { formik: FormikContext<Values> },
  any
> {
...
class CellRenderer<Values = {}, Props = {}> extends React.Component<
...
class CellEditor<Values = {}, Props = {}> extends React.Component<
  any & { formik: FormikContext<Values> },
  any
> {
  constructor(props: any) {
  ...
  handleChange = (event: any) => {
    ...
    this.props.column.colDef.cellEditorParams.formik.setFieldValue(
      `fa2[${this.props.rowIndex}].price`,
      event.target.value,
      true
    );
    this.props.column.colDef.cellEditorParams.formik.validateForm(
