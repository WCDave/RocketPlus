...
/**
 * AbstractOrderdetailId entity provides the base persistence definition of the OrderdetailId entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractOrderdetailId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AbstractOrderdetailId) ) return false;
